    ...
    >
      ...
      >
        <div className="flex items-start">
          <div className="flex-shrink-0 w-12 mr-4 h-12 bg-white rounded-md flex items-center justify-center">
      ...
      <div className="px-3 pb-3 ">
        <div className="flex items-center gap-3 mt-4">
          <div className="text-[10px] font-medium text-black px-3 py-1 border-[0.5px] border-gray-900 rounded-lg md:rounded-2xl xl:rounded-full">
